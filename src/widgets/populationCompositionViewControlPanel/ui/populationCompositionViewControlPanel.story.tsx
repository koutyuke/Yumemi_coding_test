...
import { PopulationCompositionViewControlPanel } from "./populationCompositionViewControlPanel.presenter";

const meta: Meta<typeof PopulationCompositionViewControlPanel> = {
  component: PopulationCompositionViewControlPanel,
};

export default meta;

type Story = StoryObj<typeof PopulationCompositionViewControlPanel>;

const Template: Story = {
  render: args => (
    <div className="h-full min-h-svh w-[33svw]">
      <PopulationCompositionViewControlPanel {...args} />
    </div>
  ),
};
